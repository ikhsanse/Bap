                ...
                <div class="mb-0 pb-0" id="tbl">
                    <thead>
                        <tr>
                            ...
                            <th hidden scope="col">Capaian</th>
                            <th hidden scope="col">Deskripsi Materi</th>
                ...
                success: function(data) {
                    ...
                    for (i = 0; i < data.length; i++) {
                        html += '<tr>' +
                            ...
                            '<td>' + data[i].topik + '</td>' +
                            '<td hidden>' + data[i].cp_pertemuan + '</td>' +
                            '<td hidden>' + data[i].deskripsi + '</td>' +
