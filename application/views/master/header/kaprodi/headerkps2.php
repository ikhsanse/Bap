        ...
        <ul class="navbar-nav align-items-center ml-auto">
            <!-- <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    <a class="nav-item nav-link" href="<?php echo site_url("kaprodi") ?>">Prodi BAP </a>
                    <a class="nav-item nav-link active" href="<?php echo base_url('index.php/homebap') ?>">User BAP</a>
                </div>
            </div> -->
