<nav class="navbar navbar-expand navbar-dark navigation justify-content-between">
    <div class="d-inline">
        <a class="font-weight-bold navbar-brand mr-1 text-white" style="font-size: 23;" href="<?php echo site_url("admin") ?>"><i clas style="font-size: 30px;" class="fa fa-angle-left mr-2"></i> Rekap Berita Acara</a>
