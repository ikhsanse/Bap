<nav class="navbar navbar-expand navbar-dark navigation justify-content-between" id="content">
    <div class="d-inline">
        <a class="font-weight-bold navbar-brand mr-1 text-white" style="font-size: 23;" href="<?php echo site_url("pilihrekapbulan") ?>"><i clas style="font-size: 30px;" class="fa fa-angle-left mr-2"></i> <?php echo 'Rekap Berita Acara ' . $prodi ?></a>
        ...
        <ul class="navbar-nav align-items-center ml-auto">
            <!-- <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    <a class="nav-item nav-link active" href="<?php echo base_url('index.php/kaprodi') ?>">Prodi BAP </a>
